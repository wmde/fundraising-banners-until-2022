...
import CloseIconDefault from '../../../components/Icons/CloseIconDefault';
			...
			>
				<TranslationContext.Provider value={props.translations}>
					<div className="wmde-banner-wrapper">
						<ButtonClose onClick={ this.closeBanner } icon={ <span>Jetzt nicht unterstützen <CloseIconDefault/></span> }/>
