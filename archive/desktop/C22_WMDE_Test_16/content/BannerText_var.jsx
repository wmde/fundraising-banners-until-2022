...
export default function BannerText( props ) {
	...
	return <div>
		...
		<p>
			...
			entwickeln. { animatedVisitorsVsDonorsSentence } Die meisten Menschen spenden, weil sie Wikipedia nützlich
			finden. Hat Wikipedia Ihnen in diesem Jahr Wissen im Wert einer Tasse Kaffee geschenkt? Dann
