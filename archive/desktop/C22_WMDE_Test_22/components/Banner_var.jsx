...
export class Banner extends Component {
	...
	render( props, state, context ) {
		...
		const SoftCloseContent = props.softCloseContent;
		...
		>
			...
			>
				<TranslationContext.Provider value={props.translations}>
					...
					>
						<SoftCloseContent dynamicCampaignText={ this.dynamicCampaignText } daysLeft={ props.campaignProjection.getRemainingDays() }/>
					</SoftClose>
