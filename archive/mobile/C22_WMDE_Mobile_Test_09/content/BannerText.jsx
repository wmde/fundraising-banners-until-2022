...
export default function BannerText( props ) {
	...
	return <div className="banner-text">
		...
		<p>Vielleicht kommen wir gerade ungelegen, aber dennoch: Klicken Sie jetzt bitte nicht weg! Am
			...
			erfolgreich entwickeln. <span className="wmde-banner-text-animated-highlight">Millionen Menschen nutzen
			Wikipedia, aber 99&nbsp;% spenden nicht – sie übergehen diesen Aufruf.</span> Die meisten
