...
export default function BannerText( props ) {
	...
	return <div>
		...
		<p>
			Vielleicht kommen wir gerade ungelegen, aber dennoch: Klicken Sie
			jetzt bitte nicht weg! Am heutigen { currentDayName } bitten wir Sie bescheiden, die Unabhängigkeit
			von Wikipedia zu sichern.
			Auf Wikipedia gibt es keine Werbung oder Bezahlschranken; sie finanziert sich
			durch Spenden von durchschnittlich 22,66&nbsp;€.
			...
			aber 99 % spenden nicht – sie übergehen diesen Aufruf.</span> Die meisten Menschen spenden,
			weil sie Wikipedia nützlich finden.
