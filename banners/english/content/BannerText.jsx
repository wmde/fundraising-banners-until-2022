...
export default function BannerText( props ) {
	const { currentDayName, currentDate } = props.dynamicCampaignText;
	...
	return <div>
		...
		<p>
			...
			you can, please join the 1% of readers who give. <span className="wmde-banner-text-animated-highlight">If
