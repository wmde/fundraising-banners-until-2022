const Translations = {
	...
	'address-type-notice-none': 'You waive the donation receipt and an e-mail confirmation of your' +
		' donation. You do not get any information from us, when Wikipedia needs help again.'
};
