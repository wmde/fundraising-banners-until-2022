...
export default function BannerText( props ) {
	...
	return <div className="banner-text">
		...
		<p>Vielleicht kommen wir gerade ungelegen, aber dennoch: Klicken Sie jetzt bitte nicht
			...
			erfolgreich entwickeln. { animatedVisitorsVsDonorsSentence } Die meisten Menschen spenden,
			weil sie Wikipedia nützlich finden. Hat Wikipedia Ihnen in diesem Jahr Wissen im
			Wert einer Tasse Kaffee geschenkt? Dann nehmen Sie sich doch bitte eine Minute
