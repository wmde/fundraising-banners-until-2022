		...
		<div className="banner-text-inner">
			...
			<div className="banner-text-var">
				...
				<p>
					...
					{ overallImpressionCount > 1 ?
						'Dies ist der ' + overallImpressionCount + '. Spendenaufruf, den wir Ihnen zeigen. Am heutigen ' +
						currentDayName + ' bitten wir Sie bescheiden, die Unabhängigkeit von Wikipedia zu verteidigen. ' :
						'Zum ersten Mal seit langem möchten wir Sie an diesem ' + currentDayName + 'bescheiden darum bitten, die ' +
						'Unabhängigkeit von Wikipedia zu verteidigen. '
					}
