...
export default function Slides( props, onSubmit, onFormInteraction, goToSlide ) {
	...
	const Icon = <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path
			d="M8.80003 5.73332V11.7173H10.2667V13.0667H5.96937V11.7173H7.33337V7.19999H5.8667V5.73332H8.80003ZM7.33337 2.79999H8.80003V4.26665H7.33337V2.79999Z"
			fill="white"/>
	</svg>;
	const DonationForm = props.donationForm;
	const formButton = <button className="button-group__button" onClick={ () => goToSlide( 4 ) }>
		<span className="button-group__label">Weiter, um zu spenden</span>
	</button>;
