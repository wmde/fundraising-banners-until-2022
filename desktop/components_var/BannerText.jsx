...
export default function BannerText( props ) {
	...
	const { currentDayName, campaignDaySentence, visitorsVsDonorsSentence, toggleFundsModal } = props;
	...
	return <div className="banner-text">
		...
		<p>
			{ campaignDaySentence } Zum ersten Mal seit langem möchten wir Sie an diesem { currentDayName } bescheiden
