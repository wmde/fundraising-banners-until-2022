...
export default function BannerText( props ) {
	...
	return <div className="banner-text">
		...
		<p className="text__paragraph">
			<span>{ campaignDaySentence }
			Wikipedia wird durch Spenden von durchschnittlich 23,83 € finanziert, aber 99 % der Leserinnen und Leser
				spenden nicht. </span>
        ...
        Wenn alle, die das jetzt lesen, einen kleinen Beitrag leisten, wäre unser Spendenziel bereits am heutigen { currentDayName }  erreicht. </span>
			...
			<span>Schon der Preis einer Tasse Kaffee würde genügen. Über { campaignParamters.millionImpressionsPerDay } Millionen
			...
			<span className="optional-text text-m">
				<span>Wenn Wikipedia eine kommerzielle Seite sein würde, wäre das ein riesiger Verlust für die Welt. </span>
			Wikipedia ist ein Ort des Lernens – Werbung hat darin keinen Platz.
        ...
        Das Herzstück von Wikipedia ist die Gemeinschaft von Menschen, die uns unbegrenzten Zugang zu verlässlichen und neutralen Informationen geben. </span>
			...
			<span>Es ist leicht, diese Nachricht zu ignorieren und die meisten werden das wohl tun.
				{/* eslint-disable-next-line max-len */}
			Wenn Sie Wikipedia nützlich finden, nehmen Sie sich { weekdayPrepPhrase } { currentDayName } bitte eine Minute Zeit und geben Wikipedia mit Ihrer Spende etwas zurück</span>
