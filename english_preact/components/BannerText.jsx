	...
	return <div className="banner-text">
		...
		<p className="text__paragraph">
			...
			<span> { weekdayPrepPhrase } { currentDayName } we humbly ask you to protect Wikipedia's independence.
				{ campaignDaySentence.getSentence() } We depend on donations averaging about €&nbsp;23.83, but 99% of our readers
			don't give.
			...
			<span> Thank you! </span>
			<span className="optional-text"> If Wikipedia gave you <span className="no-wrap">€ 5</span> worth of knowledge
