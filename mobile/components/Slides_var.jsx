...
export default function Slides( { formattedGoalDonationSumNumeric, currentDayName, progressBar } ) {
	return <div className="mini-banner-carousel">
		...
		<div className="carousel-cell">
			...
			<p><span className="text-highlight">Millionen Menschen nutzen Wikipedia, aber 99 % der Leserinnen und Leser spenden nicht</span>. Wenn alle, die das
