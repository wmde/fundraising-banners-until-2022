...
export default function Slides( dynamicCampaignText ) {
	...
	return [
		...
		{
			content: <div>
				<p>Wikipedia wird durch Spenden von durchschnittlich 22,66&nbsp;€ finanziert. <strong>Doch auch 5&nbsp;€ helfen,
					damit sie zuverlässig, umfassend, informativ und jederzeit zugänglich bleibt.</strong></p>
			</div>
		},
		{
			content: <div>
