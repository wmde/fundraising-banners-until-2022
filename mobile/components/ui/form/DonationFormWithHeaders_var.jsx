...
import ChevronRightIcon from '../../../../desktop/components/ui/ChevronRightIcon';
import { slideThreeContent } from '../../ModalContent';
...
export default function DonationFormWithHeaders( props ) {
	...
	const onShowModal = e => {
		e.preventDefault();
		props.showModal( slideThreeContent, false );
	};
	...
	return <div className="form">
		<form method="post" name="donationForm" className="form__element" action={ formAction }>
			...
			<fieldset className="form__section">
				<legend className="form__section-head">
					{ Translations[ 'amounts-header' ]}
					<button className="payments-info" onClick={ onShowModal }>i</button>
				</legend>
				<div className={ 'form-field-group' }>
					<SelectGroup
			...
			<fieldset className="form__section">
				...
				<div className="form-field-group">
					<SelectGroup
						...
						errorPosition={ props.errorPosition }
					>
						{ paymentInterval === Intervals.ONCE.value && selectedAmount === '5' && (
							<SmsBox/>
						) }
					</SelectGroup>
				</div>
			...
			<div className={ classNames(
				'submit-section',
				'button-group',
				{ 'is-valid': paymentInterval && selectedAmount && paymentMethod }
			) }>
			...
			<div className="footer-box">
				<p>Oder auf folgendes Konto überweisen:</p>
				<Footer/>
			</div>
