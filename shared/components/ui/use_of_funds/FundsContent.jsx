...
export default class FundsModal extends Component {
	// TODO document props, e.g. toggleFundsModal is required, onCallToAction optional
	constructor( props ) {
		super( props );
	}
	...
	render( props ) {
		...
		return <div className="use_of_funds">
			...
			<div className="banner_model__section use_of_funds__section--call_to_action">
				<button className="use_of_funds__button" onClick={onCallToAction}>Jetzt spenden</button>
			</div>
