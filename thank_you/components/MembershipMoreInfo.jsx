...
export default function MembershipMoreInfo( props ) {
	...
	return <div className="more-info__wrapper">
		...
		<div className="more-info__text">
			<ImageWithCopyright/>
			<p>Ich möchte mich von ganzem Herzen bei den wunderbaren {props.numberOfDonors} Menschen bedanken,
				die in den vergangenen Wochen gespendet haben. Mit ihrer Hilfe konnten wir unser Spendenziel erreichen.
			...
			<p>Wikipedias Unabhängigkeit wird durch Spenden ermöglicht. Es gibt darüber hinaus einen kleinen Kreis von
				derzeit {props.numberOfMembers} Menschen in Deutschland, die das Projekt nachhaltig mit einer
				Mitgliedschaft unterstützen. Zusammen können wir</p>
