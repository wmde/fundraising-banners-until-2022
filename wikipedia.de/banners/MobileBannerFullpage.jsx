...
export default class MobileBannerFullpage extends Component {
	render( props ) {
		...
		return <div id="frbanner"
					className={classNames( 'frbanner', { 'visible': props.isFullPageVisible && props.bannerVisible } )}>
				...
				<div id="modal-signup" className="cf">
					<div className="infobox">
						...
						<div className="call-to-action">
							Jetzt sind Sie <span
							className="call-to-action__optional-text">in Deutschland</span> gefragt.
						</div>
