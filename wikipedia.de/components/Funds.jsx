	...
	return <div className="wlightbox-contents">
		<div id="info-application-of-funds">
			<div className="wlightbox-title clearfix">
				...
				<a href="http://wikimedia.de/wiki/Transparenz" target="_blank">
					<span className="logo-itz-white f-right no-margin"></span>
				</a>
			</div>
			<p>
			...
			<div id="info-application-of-funds-footer">
				<div>
					<a id="link-wmf-annual-plan"
						...
						target="_blank">Erfahren Sie mehr zum Jahresplan<br/>der Wikimedia Foundation
					</a>
				</div>
				<div>
					<a id="link-wmde-annual-plan" href="https://meta.wikimedia.org/wiki/Wikimedia_Deutschland/Planung_2018" target="_blank">
						Erfahren Sie mehr zum Jahresplan<br />von Wikimedia Deutschland
					</a>
				</div>
			</div>
		</div>
