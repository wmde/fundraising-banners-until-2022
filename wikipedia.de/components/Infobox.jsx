	...
	return <div className="infobox__text">
		...
		<p className="text__paragraph">
			...
			<span className="optional-text text-max-xl">
				Wenn Sie Wikipedia nützlich finden, nehmen Sie sich {weekdayPrepPhrase} {currentDayName} bitte eine Minute Zeit und geben Wikipedia mit Ihrer Spende etwas zurück.
			</span>

			<span className="optional-text text-xl">
				Wenn Sie Wikipedia nützlich finden, nehmen Sie sich {weekdayPrepPhrase} {currentDayName} bitte eine Minute Zeit.
				Geben Sie mit Ihrer Spende etwas zurück, damit Wikipedia weiter wachsen kann.
			</span>
