	...
	return [
		{ content: <div>
			...
			<p>Bitte verzeihen Sie die Störung. Es ist ein bisschen unangenehm, daher kommen wir gleich zur Sache.
				An diesem { dynamicCampaignText.currentDayName } sind Sie in Deutschland gefragt. { dynamicCampaignText.campaignDaySentence }</p>
		</div> },
		{ content: <div>
			<p>Wikipedia wird durch Spenden von durchschnittlich 21,60&nbsp;€ finanziert, aber 99&nbsp;% der Leserinnen und Leser
				spenden nicht. <strong>Wenn alle, die das jetzt lesen, einen kleinen Beitrag leisten, wäre unser Spendenziel
					bereits am heutigen { dynamicCampaignText.currentDayName } erreicht.</strong>
			</p>
		</div> },
		{ content: <div>
			<p>
				Menschen spenden aus einem einfachen Grund – weil Wikipedia nützlich ist. Schon der Preis einer Tasse Kaffee
				würde genügen. { dynamicCampaignText.visitorsVsDonorsSentence }
			</p>
		</div> },
		{ content: <div>
		...
		{ content: <div>
			<p>Es ist leicht, diese Nachricht zu ignorieren und die meisten werden das wohl tun. Wenn Sie Wikipedia nützlich finden,
				nehmen Sie sich an diesem { dynamicCampaignText.currentDayName } bitte eine Minute Zeit und geben Wikipedia mit Ihrer
				Spende etwas zurück. Vielen Dank!</p>
		</div> }
	];
}
